    ...
    <div className="w-full flex justify-between p-5 text-[#1C1D22] dark:text-white">
      ...
      <div className="flex justify-center items-center text-2xl gap-5 text-[#FFFFFF80]">
        ...
        <div className="cursor-pointer rounded-full">
          {userPhoto === null ? (
            <div
              className="w-[40px] h-[40px] flex items-center justify-center rounded-full text-white font-semibold"
              style={{ backgroundColor: getColorFromName(localStorage.name) }}
            >
              {localStorage.name
